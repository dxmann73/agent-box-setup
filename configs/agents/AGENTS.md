...
- If a plan includes UX changes, include or update corresponding user-facing documentation
  references in the same plan.
...
- Destructive operations and commands are forbidden unless explicitly allowed e.g. `reset --hard`,
  `clean`, `restore`, `rm`
