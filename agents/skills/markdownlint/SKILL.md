...
```bash
bash ~/projects/agent-box-setup/agents/skills/markdownlint/scripts/prettier-wrap.sh
```

1. Lint with ignore-path support:

```bash
bash ~/projects/agent-box-setup/agents/skills/markdownlint/scripts/lint-fix.sh
```
...
- In this repo, `agents/skills` is ignored. Linting `agents/skills/.../SKILL.md`
