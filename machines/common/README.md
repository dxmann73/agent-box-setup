...
Install guides that apply to **both** the host and the agent VM. Each file carries the full install
and verification detail; the ordered, target-specific entry points are
